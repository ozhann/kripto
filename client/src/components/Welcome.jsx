  ...
  return (
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
        ...
        <div className='flex flex-1 justify-start flex-col mt-10 mf:ml-10'>
          <h1 className='text-3xl sm:text-4xl text-white text-gradient py-1'>
            Send Crypto <br /> without any borders
          </h1>
          <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base '>
            Explore the world of crypto. Buy and sell cryptocurrencies on Kripto
          </p>
          {!currentAccount && (
            <button
              type='button'
